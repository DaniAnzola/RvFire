...
public class Registro extends AppCompatActivity {
    ...
    private EditText etCorreoR, etContraseniaR, etNombreR,etApellidoR,etNumero;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etApellidoR = (EditText) findViewById(R.id.etApellidoR);
        ...
        btnRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                apellido = etApellidoR.getText().toString().trim();
                            ...
                            mRef.child(uid).setValue(u).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(Registro.this, "Te Pillé", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });

                        }else{
                            Toast.makeText(Registro.this, "No se ha podido registrar, intentelo más tarde", Toast.LENGTH_SHORT).show();
                        }
